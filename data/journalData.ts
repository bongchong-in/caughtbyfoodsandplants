...
export const staticText = {
  ...
  about: {
    ...
    body: "Hi, I'm Paromita. Welcome to my digital scrapbook. This isn't a food blog with perfect measurements; it's a collection of instincts. It's about the pinch of salt my mother taught me, and the stubborn hibiscus that finally bloomed this morning.",
    cta: "Read full story",
    year: "2024",
    fullStory: "My journey with food began not in a culinary school, but on a small wooden stool in my grandmother's kitchen in Kolkata. I watched her grind mustard seeds on a 'shil-nora' (stone grinder), her hands moving with a rhythm that felt like a dance. She told me that cooking isn't just chemistry; it's a transfer of energy. If you cook with anger, the food tastes bitter. If you cook with patience, even boiled potatoes taste like a feast.\n\nWhen I moved to this city, into this high-rise apartment with a 4ft balcony, I felt untethered. The soil here smelled different, the air felt rushed. But then I planted my first Hibiscus. It struggled, dropped leaves, and tested my patience. But the day it bloomed, I felt a root grow from my own feet into this concrete floor.\n\nThis journal is my attempt to document these small miracles. The perfect texture of a 'luchi' on a Sunday morning, the first rain hitting the thirsty soil of my pots, the smell of 'shiuli' flowers that only exist in my memory of autumn. It is imperfect, messy, and deeply personal. I hope you find a piece of your own story here, hidden between the recipes and the leaves."
  },
  sections: {
    food: {
